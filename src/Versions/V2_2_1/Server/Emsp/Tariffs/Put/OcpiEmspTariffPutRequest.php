...
namespace Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Tariffs\Put;
...
use Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Tariffs\OcpiTariffUpdateRequest;
...
class OcpiEmspTariffPutRequest extends OcpiTariffUpdateRequest
{
    ...
    public function __construct(ServerRequestInterface $request, TariffRequestParams $params)
    {
        ...
        PayloadValidation::coerce('V2_2_1/eMSP/Server/Tariffs/tariffPutRequest.schema.json', $this->jsonBody);
