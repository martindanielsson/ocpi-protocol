...
namespace Chargemap\OCPI\Versions\V2_2\Client\Tokens\Get;

use Chargemap\OCPI\Common\Client\Modules\Tokens\Get\GetTokenResponse as BaseResponse;
use Chargemap\OCPI\Common\Server\Errors\OcpiInvalidPayloadClientError;
use Chargemap\OCPI\Versions\V2_2\Common\Factories\TokenFactory;
...
class GetTokenResponse extends BaseResponse
{
    ...
    {
        $json = self::toJson($response, 'V2_2/eMSP/Client/Tokens/tokenGetResponse.schema.json');
