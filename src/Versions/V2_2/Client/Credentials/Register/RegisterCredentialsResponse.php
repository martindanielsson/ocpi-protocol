...
namespace Chargemap\OCPI\Versions\V2_2\Client\Credentials\Register;
...
class RegisterCredentialsResponse extends AbstractResponse
{
    ...
    public static function fromResponseInterface(ResponseInterface $response): self
    {
        ...
        $json = self::toJson($response, 'V2_2/eMSP/Client/Credentials/credentialPostResponse.schema.json');
