...
namespace Chargemap\OCPI\Versions\V2_2\Server\Emsp\Tokens\Post;

use Chargemap\OCPI\Common\Server\OcpiBaseRequest;
use Chargemap\OCPI\Common\Utils\PayloadValidation;
use Chargemap\OCPI\Versions\V2_2\Common\Factories\LocationReferencesFactory;
...
class OcpiEmspTokenPostRequest extends OcpiBaseRequest
{
    ...
    public function __construct(ServerRequestInterface $request, string $tokenUid)
    {
        ...
        if (!empty($request->getBody()->__toString())) {
            ...
            PayloadValidation::coerce('V2_2/eMSP/Server/Tokens/tokenPostRequest.schema.json', $this->jsonBody);
