...
namespace Chargemap\OCPI\Versions\V2_2\Server\Emsp\Locations\Evses\Patch;

use Chargemap\OCPI\Common\Server\Errors\OcpiGenericClientError;
use Chargemap\OCPI\Common\Utils\PayloadValidation;
use Chargemap\OCPI\Versions\V2_2\Common\Factories\PartialEvseFactory;
...
class OcpiEmspEvsePatchRequest extends BaseEvseUpdateRequest
{
    ...
    public function __construct(ServerRequestInterface $request, LocationRequestParams $params)
    {
        ...
        PayloadValidation::coerce('V2_2/eMSP/Server/Locations/Evses/evsePatchRequest.schema.json', $this->jsonBody);
