...
namespace Chargemap\OCPI\Versions\V2_2\Server\Emsp\Sessions\Patch;

use Chargemap\OCPI\Common\Server\Errors\OcpiGenericClientError;
use Chargemap\OCPI\Common\Utils\PayloadValidation;
use Chargemap\OCPI\Versions\V2_2\Common\Factories\PartialSessionFactory;
use Chargemap\OCPI\Versions\V2_2\Common\Models\PartialSession;
use Chargemap\OCPI\Versions\V2_2\Server\Emsp\Sessions\OcpiSessionUpdateRequest;
...
class OcpiEmspSessionPatchRequest extends OcpiSessionUpdateRequest
{
    ...
    public function __construct(ServerRequestInterface $request, string $countryCode, string $partyId, string $sessionId)
    {
        ...
        PayloadValidation::coerce('V2_2/eMSP/Server/Sessions/sessionPatchRequest.schema.json', $this->jsonBody);
